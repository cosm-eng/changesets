...
```
yarn add --dev @cosm-changesets/cli
yarn changeset init
```
...
A changeset that major bumps `@cosm-changesets/cli` would look like this:

```md
---
"@cosm-changesets/cli": major
---
